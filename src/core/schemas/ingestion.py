...
class IngestRequest(BaseModel):
    ...
    async_processing: bool = Field(
        default=False,
        description="Process document asynchronously and return job ID for tracking"
    )
...
class IngestResponse(BaseModel):
    ...
    status: Literal["success", "partial_success", "failed", "processing"]
    doc_id: str
    summary: str
    chunks_ingested: int
...
class IngestionProgress(BaseModel):
    ...
    status: Literal["pending", "running", "completed", "failed", "cancelled", "partial_success"] = Field(
    ...
    error_messages: List[str] = Field(default=[], description="Recent error messages")
    warnings: List[str] = Field(default=[], description="Recent warning messages")
    result_summary: Dict[str, Any] = Field(default={}, description="Job result summary")
...
class BatchIngestResponse(BaseModel):
    ...
    batch_id: str
    job_id: str = Field(..., description="Job ID for tracking batch progress")
    status: Literal["queued", "processing", "completed", "failed", "partial_success"]
    total_documents: int
