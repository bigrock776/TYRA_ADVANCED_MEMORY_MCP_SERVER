...
HSET circuit_breaker:neo4j state "closed"
HSET circuit_breaker:neo4j failure_count 0
HSET circuit_breaker:neo4j last_failure_time 0
HSET circuit_breaker:neo4j threshold 5
HSET circuit_breaker:neo4j timeout 60
...
HSET provider:registry graph_engine "neo4j"
...
HGET circuit_breaker:neo4j state
...
main() {
    ...
    log "- Circuit breaker states initialized for PostgreSQL, Neo4j, and embedding services"
